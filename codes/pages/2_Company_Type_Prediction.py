...
st.set_page_config(page_title="COMPANY TYPE PREDICTION", page_icon="📈", layout="wide")
...
def main():
    ...
    st.title("COMPANY TYPE PREDICTION")
    st.markdown("### This page predicts the Company Type of the alumni based on their current Education Major, Degree, Industry and Location.")
    st.divider()
